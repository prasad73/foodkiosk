...
void setup() {
  ...
  String url = post_link;
  Serial.print("Requesting URL: ");
  Serial.println(post_host+url);
  ...
  /*client.print(String("POST ") + url + " HTTP/1.1\r\n" +
               ...
               "x-api-key: oplpsOtoCt2b1tyztPsKO233c5w6qi3Mx0B8rsCb" + "\r\n" +
               "Content-Type: application/json" + "\r\n" +
               "Content-Length:" + sensor_json.length()+ "\r\n" 
               "body:" + sensor_json + "\r\n" +
               "Connection: close\r\n\r\n");
  */

  /*String response = String(client.print(String("PUT") + url + " HTTP/1.1\r\n" +
               "Host: " + post_host + "\r\n" +
               "x-api-key: oplpsOtoCt2b1tyztPsKO233c5w6qi3Mx0B8rsCb" + "\r\n" +
               "Accept: application/json" + "\r\n" +
               "Content-Type: application/json" + "\r\n" +
  ...
  */
  ...
  if ((WiFi.status() == WL_CONNECTED)) {
    ...
    https.begin(client, "https://locker-iot-api.versicles.com/locker-box"); //HTTPS
