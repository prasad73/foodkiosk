...
#define get_link "https://locker-api.versicles.com/locker/64b8dfd7a0c4789b61104c3c.json"  //Update this link for different lockers
#define parse_check "{\"id\": \"64b8dfd7a0c4789b61104c3c\""                               //update this json response for every locker
...
String web_sequence = "";   //"0:0:0:0:0:0:0:0:0:&"
bool Unlock_doors_keep_food[] = {false,false,false,false,false,false,false,false,false};
bool Unlock_doors_Collect_food[] = {false,false,false,false,false,false,false,false,false};

bool response_is_locked[] =  {true, true, true, true, true, true, true, true, true};
bool response_is_Occupied[] = {false,false,false,false,false,false,false,false,false};
bool response_temp_threshold[] = {false,false,false,false,false,false,false,false,false};
bool update_boxes[] = {false,false,false,false,false,false,false,false,false};
bool response_sent[] = {false,false,false,false,false,false,false,false,false};

bool push_web_status = true;

String locker_box_ids[] ={"64b8dfd7a0c4789b61104c3d","64b8dfd7a0c4789b61104c3e","64b8dfd7a0c4789b61104c3f","64b8dfd7a0c4789b61104c40","64b8dfd7a0c4789b61104c41","64b8dfd7a0c4789b61104c42","64b8dfd7a0c4789b61104c43","64b8dfd7a0c4789b61104c44","64b8dfd7a0c4789b61104c45"};
...
void Get_web_Status(){
...

	{
	  ...
	  const char* id = doc["id"]; // "64xxxxxxxxxxxxxxxxxxxxxxx3"
	  const char* name = doc["name"]; // "Rcity Corporate"
...
void SerializeJsonDoc( int i){
	...
	sensor["locker_id"] = "64b8dfd7a0c4789b61104c3c"; 
