...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("ws2812 box test - kiosk5");
...
void loop() {
  ...
  if(Serial.available()){
    ...
    if(command == 'a'){ update_column1(0, 3);}
    else if(command == 'A'){ update_column1(1, 3);}
    else if(command == '1'){ update_column1(2, 3);}

    else if(command == 'b'){ update_column1(0, 0);}
    else if(command == 'B'){ update_column1(1, 0);}
    else if(command == '2'){ update_column1(2, 0);}

    else if(command == 'c'){ update_column1(0, 4);}
    else if(command == 'C'){ update_column1(1, 4);}
    else if(command == '3'){ update_column1(2, 4);}

    else if(command == 'd'){ update_column1(0, 1);}
    else if(command == 'D'){ update_column1(1, 1);}
    else if(command == '4'){ update_column1(2, 1);}

    else if(command == 'e'){ update_column1(0, 5);}
    else if(command == 'E'){ update_column1(1, 5);}
    else if(command == '5'){ update_column1(2, 5);}

    else if(command == 'f'){ update_column1(0, 2);}
    else if(command == 'F'){ update_column1(1, 2);}
    else if(command == '6'){ update_column1(2, 2);}
