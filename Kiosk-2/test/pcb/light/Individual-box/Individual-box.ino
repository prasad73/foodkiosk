...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("ws2812 box test - kiosk2");
...
void loop() {
  ...
  if(Serial.available()){
    ...
    else if(command == 'd'){ update_column2(0, 0);}
    else if(command == 'D'){ update_column2(1, 0);}
    else if(command == 'e'){ update_column2(0, 1);}
    else if(command == 'E'){ update_column2(1, 1);}
    else if(command == 'f'){ update_column2(0, 2);}
    else if(command == 'F'){ update_column2(1, 2);}

    else if(command == 'g'){ update_column3(0, 0);}
    else if(command == 'G'){ update_column3(1, 0);}
    else if(command == 'h'){ update_column3(0, 1);}
    else if(command == 'H'){ update_column3(1, 1);}
    else if(command == 'i'){ update_column3(0, 2);}
    else if(command == 'I'){ update_column3(1, 2);}

    else if(command == 'j'){ update_column4(0, 0);}
    else if(command == 'J'){ update_column4(1, 0);}
    else if(command == 'k'){ update_column4(0, 1);}
    else if(command == 'K'){ update_column4(1, 1);}
    else if(command == 'l'){ update_column4(0, 2);}
    else if(command == 'L'){ update_column4(1, 2);}
  }
