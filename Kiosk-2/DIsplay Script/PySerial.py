...
Open_door_pick_order = [True, True, True, True, True, True, True, True, True, True, True, True]
is_Occupied = [False, False, False, False, False, False, False, False, False, False, False, False]
...
for i in range(0,12):
    is_Occupied[i] = data_json['locker_boxes'][i]['is_locked']
...
while True:
        try:
            ...
            for i in range(0,12):
                ...
                if(is_Occupied[i] == True):
                    Open_door_pick_order[i] = data_json['locker_boxes'][i]['is_locked']
                else:
                    Open_door_place_order[i] = data_json['locker_boxes'][i]['is_locked']
                        
                boxNumber = str(data_json['locker_boxes'][i]['number'])
                    
                if(is_Occupied[i] == False):
                    if(Open_door_place_order[i] == True):
